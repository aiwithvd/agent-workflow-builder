...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 flex flex-col h-screen sticky top-0 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
      {/* Logo */}
      ...
      {/* Bottom */}
      <div className="px-3 py-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
